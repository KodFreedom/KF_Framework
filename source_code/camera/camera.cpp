...
{
    Matrix44& world_rig = Matrix44::Transform(rig_.rotation, rig_.position);
    Matrix44& world_pivot = Matrix44::Transform(pivot_.rotation, pivot_.position);
    ...
    // View行列
    Vector3& negative_eye = world_eye_position_ * -1.0f;
