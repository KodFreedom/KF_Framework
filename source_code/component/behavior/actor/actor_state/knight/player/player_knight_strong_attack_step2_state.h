//--------------------------------------------------------------------------------
//  knight重攻撃ステップ2ステート
//　player_knight_strong_attack_step2_state.h
//  Author : Xu Wenjie
//--------------------------------------------------------------------------------
#pragma once
...
//  クラス宣言
//--------------------------------------------------------------------------------
class PlayerKnightStrongAttackStep2State final : public PlayerState
{
public:
    //--------------------------------------------------------------------------------
    //  constructors for singleton
    //--------------------------------------------------------------------------------
    PlayerKnightStrongAttackStep2State() : PlayerState(L"PlayerKnightStrongAttackStep2State") {}
    ~PlayerKnightStrongAttackStep2State() {}
...
private:
    ...
    static constexpr int kBeginAttackFrame = 6;
    static constexpr int kEndAttackFrame = 30;
    static constexpr int kBeginStep3Frame = 33;
};