...
void Camera::UpdateParameter(void)
{
	...
	world_right_ = Vector3::TransformNormal(Vector3::kRight, world_pivot);
	world_up_ = Vector3::TransformNormal(Vector3::kUp, world_pivot);
	world_forward_ = Vector3::TransformNormal(Vector3::kForward, world_pivot);
